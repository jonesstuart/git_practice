Purpose: Introduce, explain and share info about the repository in order to understand the project.
Should: Tell the user how to install and use the project.
